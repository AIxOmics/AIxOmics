...
<template>
        ...
        <el-row>
          ...
          >
            ...
            <h1 class="wrapper-sketch-text-content">
              Access the lab's published research and news media coverage
            </h1>
          </el-col>
        </el-row>
      </el-col>
  ...
  >
    ...
    <el-col :span="20">
      ...
      <el-check-tag
        class="publications-wrap-years"
        size="large"
        effect="plain"
        v-for="(publication, index) in publications"
        :key="index"
        checked
        @click="scrollToView(publication.year)"
        >{{ publication.year }}</el-check-tag
      >
      <el-timeline
        :id="publication.year"
        class="publications-papers"
        v-for="(publication, index) in publications"
        :key="index"
      >
        <!-- Year -->
        ...
        <!-- Papers -->
        <el-timeline-item
          v-for="(paper, index) in publication.papers"
          :key="index"
          :timestamp="paper.date"
          placement="top"
          type="success"
          size="large"
          hollow="true"
            ...
            <el-row>
              <el-col :span="screenWidth > 1600 ? 11 : 24">
                ...
                <el-image
                  ...
                  :src="paper.figure"
                  :zoom-rate="1.2"
                  :preview-src-list="[paper.figure]"
                  :initial-index="4"
                  hide-on-click-modal="true"
                ></el-image>
                <!-- Tags -->
                <el-tag
                  class="publications-papers-card-tags"
                  v-for="(tag, index) in paper.keywords"
                  :key="index"
                >
              ...
              <el-col
                :span="screenWidth > 1600 ? 12 : 24"
                :offset="screenWidth > 1600 ? 1 : 0"
              >
                <!-- Title -->
                <span class="publications-papers-card-title">{{
                  paper.title
                }}</span>
                <!-- Authors -->
                ...
                <!-- Abstract -->
                <p class="publications-papers-card-abstract">
                  {{ paper.abstract }}
                </p>
                <!-- Links -->
                <el-link
                  class="publications-papers-card-links"
                  :underline="false"
                  target="_blank"
                  type="primary"
                  v-for="(value, key, index) in paper.links"
                  :key="index"
                  :href="value"
                >
