        ...
        <el-row>
          <el-col class="wrapper-sketch-text" :span="screenWidth > 1200 ? 14 : 24">
            ...
            <h1 class="wrapper-sketch-text-content">
              Come from all over the world to meet
            </h1>
          </el-col>
        </el-row>
      </el-col>
      ...
      <el-row>
        ...
        <el-col :span="screenWidth > 1200 ? 8 : 24">
          ...
          <span class="web-text">Our research group is a happy team. There is a composition of our
            ...
            essential for fostering creativity and innovation, and as such, we
            work hard to ensure that everyone feels supported and encouraged.
            Whether we are working on a challenging project or brainstorming new
            ideas, we always approach our work with enthusiasm and a shared
            sense of purpose.
          </span>
        </el-col>
        <!-- 右侧图片 -->
